...
**Answer** Yes! User this syntax: ?eID=dd_googlesitemap&sitemap=t3extblog&pidList=123 (123 = pid where the blogposts are stored). Your posts should all listed. If you got a lot of posts, you need to add the parameter &limit=123456 to get all posts listed in the sitemap.
Since google supports RSS-Feeds, we recommend to use this solution!

6.) Filtering tags doesn´t work in some cases?!
