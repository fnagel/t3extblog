...
2. Add a new record. If not done allready, add at least one category
3. Now you can start adding your blogposts! Click „add a new record“ and choose „post“:
...
- Author: is feed by the existing BE-users
