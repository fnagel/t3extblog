...
T3ExtBlog has all lot of features needed for blogging:

- Supports migration to and is tested in TYPO3 6.2.
- Categories and tags
- All TYPO3-content-elements could be used to create blog content
- Commenting system
- Antispam
- All views are organized in modules
- Views: list, detail, latest, categories, archive, latest comments
