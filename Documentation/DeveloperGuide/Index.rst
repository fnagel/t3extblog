...
* Change version information in :code:`/composer.json` (`extra.typo3/cms.version`)
* Change year in :code:`/Documentation/guides.xml` if needed
* Change year in :code:`/Documentation/Index.rst` if needed
...
* Change version information in :code:`/composer.json` to next bugfix version + "+dev" (example: "1.2.3+dev")
