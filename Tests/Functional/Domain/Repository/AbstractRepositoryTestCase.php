...
abstract class AbstractRepositoryTestCase extends AbstractFunctionalTestCase
{
    protected function setUp(): void
    {
        ...
        // Provide a backend page context (id=1) so Extbase resolves storagePid=1
        ...
        // since Extbase v13.4.6 / v14.3.6, where a global backend request would make
        // queries include hidden records by default.
